...
set_target_properties(mediapipe PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmediapipe.so.%%PV%%"
  IMPORTED_SONAME_RELEASE "libmediapipe.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS mediapipe )
list(APPEND _IMPORT_CHECK_FILES_FOR_mediapipe "${_IMPORT_PREFIX}/lib/libmediapipe.so.%%PV%%" )
